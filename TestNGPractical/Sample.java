...
public class Sample {
	...
	@BeforeMethod
	public void setUp() {
	System.setProperty("webdriver.chrome.driver","C:\\Users\\Anubhav\\Downloads\\chromedriver-win64 (1)\\chromedriver-win64\\chromedriver.exe");
	...
	driver.get("https://www.amazon.com/");
	WebElement footerLink = driver.findElement(By.linkText("PrivacyNotice"));
	footerLink.click();
	String pageTitle = driver.getTitle();
